...
// Array of fun facts
const funFacts = [
    "Akauntan sering dirujuk sebagai 'bahasa perniagaan' kerana mereka mentafsir dan menganalisis data kewangan.",
    "Banyak akauntan mengkhusus dalam bidang tertentu, seperti perakaunan cukai, perakaunan forensik, atau perakaunan pengurusan.",
    "Pemeriksa memainkan peranan penting dalam memastikan integriti penyata kewangan, membantu mencegah penipuan dan pengurusan kewangan yang tidak betul.",
    "Konsep pemeriksaan telah wujud sejak ribuan tahun, dengan bentuk awal dipraktikkan di Mesir purba dan Mesopotamia.",
    "Setiausaha sering berfungsi sebagai tulang belakang organisasi, menguruskan jadual, komunikasi, dan operasi pejabat.",
    "Peranan setiausaha telah berkembang dengan ketara, kini sering melibatkan teknologi dan kemahiran pengurusan yang lebih maju.",
    "Kerani secara asalnya bertanggungjawab untuk mengekalkan rekod yang tepat, satu peranan yang telah berubah dengan kemunculan teknologi digital.",
    "Ramai kerani mengembangkan kemahiran organisasi yang kuat, kerana mereka sering menguruskan pelbagai tugas dan keutamaan dalam persekitaran yang sibuk."
];
...
function check_slots() {
    ...
    if (check == o) {
        ...
        setTimeout(() => {
            alert('Tahniah! Anda Berjaya menyelesaikan Puzzle ini!\n\nFakta Menarik: ' + randomFact);
